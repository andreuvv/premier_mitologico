...
Por torneo, cada jugador debe presentar al menos **dos mazos** construidos previamente al inicio del evento, un mazo por cada formato de acorde al torneo y acorde a las reglas de los formatos _**Primer Bloque Racial Libre o Racial Edición**_ y _**Bloque Furia Racial Libre o Racial Limitado**_.
...
- 🔄 **Side Deck**:
    ...
    - Se permitirá un _**side deck**_ de hasta **15 cartas** en Bloque Furia.
